...
/** @var Xbsvat\Common\Configurator $configurator */
$configurator = new Xbsvat\Common\Configurator();

/** @var \XoopsModules\Xbsvat\Common\Migrate $migrator */
$migrator = new \XoopsModules\Xbsvat\Common\Migrate($configurator);
